...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-gazebo-2.2.2)
  set(turtlebot_gazebo_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-gazebo-2.2.2/obj-x86_64-linux-gnu/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
